-- ==============================================================================
-- AUTO-CREATE PROFILES ON SIGNUP (v3 - Fixed Dependencies)
...
begin
  ...
  if v_full_name is null then v_full_name := (new.raw_user_meta_data->>'name')::text; end;
  ...
  -- Although the previous trigger should handle it, explicit checks are safer in functions
