-- ==============================================================================
-- AUTO-CREATE PROFILES ON SIGNUP (v4 - Fixed Column Names)
-- 1. Syncs auth.users -> public.users (Skipping 'name' column if missing)
...
begin
  ...
  -- Removed query for 'name' as it likely doesn't exist in public.users
...
begin
  ...
  -- 'name' DOES exist in requesters/providers tables
